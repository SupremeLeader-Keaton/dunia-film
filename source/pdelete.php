...
if (count($_POST) > 0)
  {
    mysqli_query($conn, "DELETE FROM person WHERE PERSON_ID = $id");
    $message = "OK";
  }
        ...
        <div class="card px-4 pb-3">
            <div class="card-body">
                <div class="card-header items-header mb-3" style="background-color: white;">
                    <h5><b>Penghapusan Data Individu</b></h5>
                </div>
                <?php if (isset($message))
  {
    echo "<div class='alert alert-success'>
            <b>Data Individu Berhasil Dihapus</b>
            </div>";
  } ?>
                ...
                <form method="post" action="">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="id" value="<?php echo $row['PERSON_ID']; ?>"
                            readonly>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Nama</label>
                        <input type="text" class="form-control" name="name" value="<?php echo $row['PERSON_NAME']; ?>"
                            maxlength="30" readonly>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Tahun Lahir (dan Wafat)</label>
                        <input type="text" class="form-control" name="dob" value="<?php echo $row['PERSON_DOB']; ?>"
                            maxlength="20" readonly>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Jenis Kelamin (1 = Laki, 2 = Perempuan)</label>
                        <input type="number" class="form-control" name="sex" value="<?php echo $row['PERSON_SEX']; ?>"
                            maxlength="1" readonly>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Halaman Wiki</label>
                        <input type="text" class="form-control" name="wiki" value="<?php echo $row['PERSON_WIKI']; ?>"
                            maxlength="100" readonly>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Pekerjaan (Artis dan/atau Sutradara)</label>
                        <input type="text" class="form-control" name="type" value="<?php echo $row['PERSON_TYPE']; ?>"
                            maxlength="20" readonly>
                    </div>
