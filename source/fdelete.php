        ...
        <div class="card px-4 pb-3">
            <div class="card-body">
                <div class="card-header items-header mb-3" style="background-color: white;">
                    <h5><b>Penghapusan Data Film</b></h5>
                </div>
                <?php if (isset($message))
  {
    echo "<div class='alert alert-success'>
            <b>Data Film Berhasil Dihapus</b>
            </div>";
  } ?>
                ...
                <form method="post" action="">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="id" value="<?php echo $row['FILM_ID']; ?>"
                            readonly>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Judul</label>
                        <input type="text" class="form-control" name="title" value="<?php echo $row['FILM_TITLE']; ?>"
                            maxlength="100" readonly>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Tahun</label>
                        <input type="number" class="form-control" name="year" value="<?php echo $row['FILM_YEAR']; ?>"
                            maxlength="4" readonly>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Durasi</label>
                        <input type="number" class="form-control" name="duration"
                            value="<?php echo $row['FILM_DURATION']; ?>" maxlength="3" readonly>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Genre</label>
                        <input type="text" class="form-control" name="genre" value="<?php echo $row['FILM_GENRE']; ?>"
                            maxlength="50" readonly>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Studio</label>
                        <input type="text" class="form-control" name="studio" value="<?php echo $row['FILM_STUDIO']; ?>"
                            maxlength="50" readonly>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Halaman Wiki</label>
                        <input type="text" class="form-control" name="wiki" value="<?php echo $row['FILM_WIKI']; ?>"
