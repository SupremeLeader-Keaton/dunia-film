...
if (count($_POST) > 0)
  {
    mysqli_query($conn, "INSERT INTO film VALUES (NULL ,'" . $_POST['new_title'] . "', '" . $_POST['new_year'] . "', '" . $_POST['new_duration'] . "', '" . $_POST['new_genre'] . "', '" . $_POST['new_studio'] . "', '" . $_POST['new_wiki'] . "')");
    $message = "OK";
  }
        ...
        <div class="card px-4 pb-3">
            <div class="card-body">
                <div class="card-header items-header mb-3" style="background-color: white;">
                    <h5><b>Penambahan Data Film</b></h5>
                </div>
                <?php if (isset($message))
  {
    echo "<div class='alert alert-success'>
            <b>Data Film Berhasil Ditambah</b>
            </div>";
  } ?>
                ...
                <form method="post" action="">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="new_title" maxlength="100">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Tahun</label>
                        <input type="number" class="form-control" name="new_year" maxlength="4">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Durasi (menit)</label>
                        <input type="number" class="form-control" name="new_duration" maxlength="3">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Genre (Format: Genre_1 / Genre_2 / ... )</label>
                        <input type="text" class="form-control" name="new_genre" maxlength="50">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Studio</label>
                        <input type="text" class="form-control" name="new_studio" maxlength="50">
                    </div>
                    <div class="mb-3">
