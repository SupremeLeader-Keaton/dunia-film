...
if (count($_POST) > 0)
  {
    mysqli_query($conn, "INSERT INTO cast VALUES (NULL ,'" . $_POST['add_film'] . "', '" . $_POST['add_person'] . "', '" . $_POST['add_role'] . "')");
    $message = "ADD";
  }
?>
        ...
        <div class="card px-4 pb-3">
            <div class="card-body">
                <div class="card-header items-header mb-3" style="background-color: white;">
                    <h5><b>Penambahan Data Casting</b></h5>
                </div>
                <?php if (isset($message))
  {
    echo "<div class='alert alert-success'>
<b>Data Casting Berhasil Ditambah</b>
</div>";
  } ?>

                <form method="post" action="">
                    <div class="mb-3">
                        <label class="form-label">ID Cast (Dunia Film ID)</label>
                        <input type="number" class="form-control" name="cast_id" placeholder="Otomatis" readonly>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">ID Film (Dunia Film ID)</label>
                        <input type="number" class="form-control" name="add_film" maxlength="4">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">ID Individu (Dunia Film ID)</label>
                        <input type="number" class="form-control" name="add_person" maxlength="4">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Peran Sebagai ( 1 = Artis, 2 = Sutradara (maks.1) )</label>
                        <input type="number" class="form-control" name="add_role" maxlength="1">
                    </div>
