...
if (count($_POST) > 0)
  {
    mysqli_query($conn, "INSERT INTO person VALUES (NULL ,'" . $_POST['new_name'] . "', '" . $_POST['new_dob'] . "', '" . $_POST['new_sex'] . "', '" . $_POST['new_wiki'] . "', '" . $_POST['new_type'] . "')");
    $message = "OK";
  }
        ...
        <div class="card px-4 pb-3">
            <div class="card-body">
                <div class="card-header items-header mb-3" style="background-color: white;">
                    <h5><b>Penambahan Data Individu</b></h5>
                </div>
                <?php if (isset($message))
  {
    echo "<div class='alert alert-success'>
            <b>Data Individu Berhasil Ditambah</b>
            </div>";
  } ?>
                ...
                <form method="post" action="">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="new_id" placeholder="Otomatis" readonly>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Nama</label>
                        <input type="text" class="form-control" name="new_name" maxlength="30">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Tahun Lahir (dan Wafat)</label>
                        <input type="text" class="form-control" name="new_dob" maxlength="20">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Jenis Kelamin (1 = Laki, 2 = Perempuan)</label>
                        <input type="number" class="form-control" name="new_sex" maxlength="1">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Halaman Wiki</label>
                        <input type="text" class="form-control" name="new_wiki" maxlength="100">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Pekerjaan (Artis dan/atau Sutradara)</label>
                        <input type="text" class="form-control" name="new_type" maxlength="20">
                    </div>
