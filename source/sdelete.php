...
if (count($_POST) > 0)
  {
    mysqli_query($conn, "DELETE FROM studio WHERE FILM_STUDIO = '$id' ");
    $message = "OK";
  }
$result = mysqli_query($conn, "SELECT * FROM studio WHERE FILM_STUDIO = '$id'");
        ...
        <div class="card px-4 pb-3">
            <div class="card-body">
                <div class="card-header items-header mb-3" style="background-color: white;">
                    <h5><b>Penghapusan Data Studio</b></h5>
                </div>
                <?php if (isset($message))
  {
    echo "<div class='alert alert-success'>
            <b>Data Studio Berhasil Dihapus</b>
            </div>";
  } ?>
                ...
                <form method="post" action="">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="name" value="<?php echo $row['FILM_STUDIO']; ?>"
                            maxlength="50" readonly>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Halaman Wiki</label>
                        <input type="text" class="form-control" name="wiki" value="<?php echo $row['STUDIO_WIKI']; ?>"
