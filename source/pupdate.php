...
if (count($_POST) > 0)
  {
    mysqli_query($conn, "UPDATE person SET PERSON_NAME ='" . $_POST['update_name'] . "', PERSON_DOB ='" . $_POST['update_dob'] . "', PERSON_SEX ='" . $_POST['update_sex'] . "' , PERSON_WIKI ='" . $_POST['update_wiki'] . "' , PERSON_TYPE ='" . $_POST['update_type'] . "' WHERE PERSON_ID ='" . $_POST['update_id'] . "'");
    $message = "OK";
  }
        ...
        <div class="card px-4 pb-3">
            <div class="card-body">
                <div class="card-header items-header mb-3" style="background-color: white;">
                    <h5><b>Pemutakhiran Data Individu</b></h5>
                </div>
                <?php if (isset($message))
  {
    echo "<div class='alert alert-success'>
            <b>Data Individu Berhasil Dimutakhir</b>
            </div>";
  } ?>
                ...
                <form method="post" action="">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="update_id"
                            value="<?php echo $row['PERSON_ID']; ?>" readonly>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Nama</label>
                        <input type="text" class="form-control" name="update_name"
                            value="<?php echo $row['PERSON_NAME']; ?>" maxlength="30">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Tahun Lahir (dan Wafat)</label>
                        <input type="text" class="form-control" name="update_dob"
                            value="<?php echo $row['PERSON_DOB']; ?>" maxlength="20">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Jenis Kelamin (1 = Laki, 2 = Perempuan)</label>
                        <input type="number" class="form-control" name="update_sex"
                            value="<?php echo $row['PERSON_SEX']; ?>" maxlength="1">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Halaman Wiki</label>
                        <input type="text" class="form-control" name="update_wiki"
                            value="<?php echo $row['PERSON_WIKI']; ?>" maxlength="100">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Pekerjaan (Artis dan/atau Sutradara)</label>
                        <input type="text" class="form-control" name="update_type"
                            value="<?php echo $row['PERSON_TYPE']; ?>" maxlength="20">
                    </div>
